...
# Reflection
# Marek and I had a hard time figuring out what the person who made the original code was thinking.
# In order to refactor we used the code that one of us had worked on the week before.
#
#